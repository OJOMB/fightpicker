...
// LoginResponse represents a response after a successful login
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\rLoginResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken2\xba\x01\n" +
	"\vAuthService\x126\n" +
	...
	"\aRefresh\x12\x16.google.protobuf.Empty\x1a\x16.auth.v1.LoginResponseBBZ@github.com/OJOMB/fightpicker/internal/grpc/gen/go/auth/v1;authpbb\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.v1.AuthService.Logout:input_type -> google.protobuf.Empty
	2, // 2: auth.v1.AuthService.Refresh:input_type -> google.protobuf.Empty
	1, // 3: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	2, // 4: auth.v1.AuthService.Logout:output_type -> google.protobuf.Empty
